  ...
  xmlhttp.onload = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      function editMe() {
        ...
        $("#editId").attr("placeholder", myObj.data[index].id);
        $("#editId").attr("readonly", "true");
        $("#editName").val(myObj.data[index].employee_name);
        $("#editSal").val(myObj.data[index].employee_salary);
        $("#editAge").val(myObj.data[index].employee_age);
        $("#editImage").val(myObj.data[index].profile_image);
        ...
        function saveMe() {
          ...
          if (name == "") {
            ...
            // alert(index);
            myObj.data[index].employee_name = name;
            myObj.data[index].employee_salary = salary;
            myObj.data[index].employee_age = age;
            myObj.data[index].profile_image = image;
