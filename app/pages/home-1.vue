...
<template>
  ...
  <div class="min-h-[150vh] bg-[#F9F8F6] text-[#1A1A1A] font-sans selection:bg-[#C47552] selection:text-white">
    ...
    <section class="max-w-[90rem] mx-auto pt-44 px-6 md:px-12 lg:px-24">
      <div class="max-w-3xl">
        <span class="text-[#C47552] text-xs font-bold tracking-[0.2em] uppercase block mb-4">Design Variant 01</span>
        <h1 class="font-serif text-5xl md:text-7xl tracking-tight leading-[1.1] mb-8">
          The art of moving <br class="hidden md:inline"/>
          through landscapes <span class="italic font-normal text-[#C47552]">slowly</span>.
        </h1>
        <p class="text-[#666666] text-lg md:text-xl font-light leading-relaxed mb-12 max-w-2xl">
          Scroll down to watch the circular progress element gracefully track your position around the menu interface in real-time.
        </p>
      </div>
    </section>
